...
describe('cypress assessment side menu tests', () => {
    ...
    it('dashboard item exists', () => {
        ...
        cy.xpath('//*[@id="__next"]/div/div[1]/ul/li[1]/a/span[2]').invoke('text').then((text) => {
    ...
    it('profile item exists', () => {
        // Check element and text
        cy.xpath('//*[@id="__next"]/div/div[1]/ul/li[2]/a/span[2]').invoke('text').then((text) => {
    ...
    it('notifications item exists', () => {
        // Check element and text
        cy.xpath('//*[@id="__next"]/div/div[1]/ul/li[3]/a/span[2]').invoke('text').then((text) => {
    ...
    it('logout item exists', () => {
        // Check element and text
        cy.xpath('//*[@id="__next"]/div/div[1]/ul/li[4]/a/span[2]').invoke('text').then((text) => {
    ...
    it('notification alert item exists', () => {
        // Check element and text
        cy.xpath('//*[@id="__next"]/div/div[1]/ul/li[3]/a/span[3]').invoke('text').then((text) => {
